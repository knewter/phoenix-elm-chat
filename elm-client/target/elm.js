...
var _user$project$Styles_Variables$messageBodyColor = A3(_rtfeldman$elm_css$Css$rgb, 30, 30, 30);
var _user$project$Styles_Variables$chatBackgroundColor = A3(_rtfeldman$elm_css$Css$rgb, 200, 200, 200);
var _user$project$Styles_Variables$primaryColor = A3(_rtfeldman$elm_css$Css$rgb, 255, 0, 0);

var _user$project$Styles$mainNamespace = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('main');
var _user$project$Styles$compile = _rtfeldman$elm_css$Css$compile;
var _user$project$Styles$NotAThingYet = {ctor: 'NotAThingYet'};
var _user$project$Styles$RosterUser = {ctor: 'RosterUser'};
var _user$project$Styles$Roster = {ctor: 'Roster'};
var _user$project$Styles$MessageBody = {ctor: 'MessageBody'};
var _user$project$Styles$MessageUser = {ctor: 'MessageUser'};
var _user$project$Styles$Message = {ctor: 'Message'};
var _user$project$Styles$Messages = {ctor: 'Messages'};
var _user$project$Styles$Chat = {ctor: 'Chat'};
var _user$project$Styles$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _user$project$Styles$mainNamespace.name, _p0));
}(
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_user$project$Styles$Chat,
			_elm_lang$core$Native_List.fromArray(
				[
					_rtfeldman$elm_css$Css$backgroundColor(_user$project$Styles_Variables$chatBackgroundColor),
					_rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$inlineBlock),
					_rtfeldman$elm_css$Css$width(
					_rtfeldman$elm_css$Css$em(20))
				])),
			A2(
			F2(
				function (x, y) {
			...
			_user$project$Styles$MessageUser,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_user$project$Styles$MessageBody,
			_elm_lang$core$Native_List.fromArray(
				[
					_rtfeldman$elm_css$Css$color(_user$project$Styles_Variables$messageBodyColor)
				])),
			A2(
			F2(
				function (x, y) {
			...
			_user$project$Styles$RosterUser,
			_elm_lang$core$Native_List.fromArray(
				[
					_rtfeldman$elm_css$Css$padding(
...
var _user$project$Types$Message = F2(
	function (a, b) {
...
var _user$project$Chat$viewMessage = function (message) {
	var _p0 = _user$project$Styles$mainNamespace;
	var $class = _p0.$class;
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(_elm_lang$core$Basics_ops['++'], message.user, ': '))
					])),
				A2(
				_elm_lang$html$Html$span,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(message.body)
					]))
			]));
};
var _user$project$Chat$userView = function (user) {
	return A2(
...
var _user$project$Chat$userListView = function (model) {
	return A2(
		_elm_lang$html$Html$ul,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('users')
			]),
		A2(_elm_lang$core$List$map, _user$project$Chat$userView, model.users));
};
var _user$project$Chat$messageListView = function (model) {
	var _p1 = _user$project$Styles$mainNamespace;
	var $class = _p1.$class;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
...
var _user$project$Chat$Model = F4(
	function (a, b, c, d) {
		return {newMessage: a, topic: b, messages: c, users: d};
	});
...
var _user$project$Chat$messageInputView = function (model) {
	return A2(
...
var _user$project$Chat$view = function (model) {
	var _p2 = _user$project$Styles$mainNamespace;
	var $class = _p2.$class;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Chat$messageListView(model),
				_user$project$Chat$messageInputView(model),
				_user$project$Chat$userListView(model)
			]));
};
var _user$project$Chat$Say = function (a) {
			...
			case 'SendMessage':
				return {
					...
					_2: _elm_lang$core$Maybe$Just(
						_user$project$Chat$Say(model.newMessage))
				};
			default:
				var _p4 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Chat$chatMessageDecoder, _p3._0);
				if (_p4.ctor === 'Ok') {
					return {
						ctor: '_Tuple3',
						_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$Phoenix_Presence$merge = F6(
	function (leftStep, bothStep, rightStep, leftDict, rightDict, initialResult) {
		var stepState = F3(
...
var _user$project$Phoenix_Presence$syncState = F2(
	function (newState, state) {
		return newState;
	});
var _user$project$Phoenix_Presence$list = function (mapper) {
	return function (_p11) {
		return _elm_lang$core$Dict$values(
			A2(_elm_lang$core$Dict$map, mapper, _p11));
	};
};
var _user$project$Phoenix_Presence$listDefault = _elm_lang$core$Dict$values;
var _user$project$Phoenix_Presence$PresenceStateMetaWrapper = function (a) {
	return {metas: a};
};
var _user$project$Phoenix_Presence$syncDiff = F2(
	function (diff, state) {
		var mergeJoins = F2(
			function (left, right) {
				var inBoth = F4(
					function (key, leftValue, rightValue, acc) {
						return A3(
							_elm_lang$core$Dict$insert,
							key,
							_user$project$Phoenix_Presence$PresenceStateMetaWrapper(
								A2(_elm_lang$core$Basics_ops['++'], leftValue.metas, rightValue.metas)),
							acc);
					});
				return A6(_user$project$Phoenix_Presence$merge, _elm_lang$core$Dict$insert, inBoth, _elm_lang$core$Dict$insert, left, right, _elm_lang$core$Dict$empty);
			});
		var mergeLeaves = F3(
			function (leaves, key, currentMetaWrapper) {
				...
				if (_p12.ctor === 'Nothing') {
					...
					var leftRefs = A2(
						...
						_p12._0.metas);
					return _user$project$Phoenix_Presence$PresenceStateMetaWrapper(
						A2(
							_elm_lang$core$List$filter,
							function (metaValue) {
								return _elm_lang$core$Basics$not(
...
var _user$project$Phoenix_Presence$PresenceStateMetaValue = F2(
	function (a, b) {
		return {phx_ref: a, payload: b};
	});
var _user$project$Phoenix_Presence$presenceStateMetaDecoder = function (payloadDecoder) {
	var createFinalRecord = F2(
		function (phxRef, payload) {
			return _elm_lang$core$Json_Decode$succeed(
				A2(_user$project$Phoenix_Presence$PresenceStateMetaValue, phxRef, payload));
		});
...
var _user$project$Phoenix_Presence$presenceStateMetaWrapperDecoder = function (payloadDecoder) {
	return A2(
		...
		A2(
			...
			_elm_lang$core$Json_Decode$list(
				_user$project$Phoenix_Presence$presenceStateMetaDecoder(payloadDecoder))));
};
var _user$project$Phoenix_Presence$presenceStateDecoder = function (payloadDecoder) {
	return _elm_lang$core$Json_Decode$dict(
		_user$project$Phoenix_Presence$presenceStateMetaWrapperDecoder(payloadDecoder));
};
var _user$project$Phoenix_Presence$PresenceDiff = F2(
	function (a, b) {
		return {leaves: a, joins: b};
	});
var _user$project$Phoenix_Presence$presenceDiffDecoder = function (payloadDecoder) {
	return A3(
		_elm_lang$core$Json_Decode$object2,
		_user$project$Phoenix_Presence$PresenceDiff,
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'leaves',
			_user$project$Phoenix_Presence$presenceStateDecoder(payloadDecoder)),
		A2(
			_elm_lang$core$Json_Decode_ops[':='],
			'joins',
			_user$project$Phoenix_Presence$presenceStateDecoder(payloadDecoder)));
...
var _user$project$Main$socketServer = function (username) {
	return A2(_elm_lang$core$Basics_ops['++'], 'ws://localhost:4000/socket/websocket?username=', username);
};
var _user$project$Main$initialModel = {
	username: '',
	chats: _elm_lang$core$Dict$empty,
...
var _user$project$Main$UserPresence = F2(
	function (a, b) {
		return {online_at: a, device: b};
	});
var _user$project$Main$userPresenceDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Main$UserPresence,
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {username: a, chats: b, phxSocket: c, phxPresences: d, users: e};
	});
var _user$project$Main$ChatWithUser = function (a) {
	return {ctor: 'ChatWithUser', _0: a};
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Main$ChatWithUser(user))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(user.name)
...
var _user$project$Main$rosterView = function (model) {
	var _p1 = _user$project$Styles$mainNamespace;
	var $class = _p1.$class;
	return A2(
		_elm_lang$html$Html$div,
		...
		A2(_elm_lang$core$List$map, _user$project$Main$userView, model.users));
};
var _user$project$Main$ChatMsg = F2(
	function (a, b) {
		return {ctor: 'ChatMsg', _0: a, _1: b};
	});
var _user$project$Main$chatViewListItem = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Main$ChatMsg(_p3._0),
				_user$project$Chat$view(_p3._1))
			]));
};
var _user$project$Main$chatsView = function (model) {
	var chatViews = A2(
		_elm_lang$core$List$map,
		_user$project$Main$chatViewListItem,
		_elm_lang$core$Dict$toList(model.chats));
	return A2(
		_elm_lang$html$Html$ul,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$Main$ReceiveChatMessage = F2(
	function (a, b) {
		return {ctor: 'ReceiveChatMessage', _0: a, _1: b};
	});
var _user$project$Main$HandlePresenceDiff = function (a) {
	return {ctor: 'HandlePresenceDiff', _0: a};
};
var _user$project$Main$HandlePresenceState = function (a) {
	return {ctor: 'HandlePresenceState', _0: a};
};
var _user$project$Main$initPhxSocket = function (username) {
	return A4(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
		'presence_diff',
		'room:lobby',
		_user$project$Main$HandlePresenceDiff,
		A4(
			_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
			'presence_state',
			'room:lobby',
			_user$project$Main$HandlePresenceState,
			_fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(
				_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(
					_user$project$Main$socketServer(username)))));
};
var _user$project$Main$ConnectSocket = {ctor: 'ConnectSocket'};
var _user$project$Main$SetUsername = function (a) {
	return {ctor: 'SetUsername', _0: a};
};
var _user$project$Main$setUsernameView = A2(
	_elm_lang$html$Html$form,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Events$onSubmit(_user$project$Main$ConnectSocket)
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Attributes$placeholder('Enter a username')
				]),
			_elm_lang$core$Native_List.fromArray(
				[]))
		]));
...
var _user$project$Main$handleChatOutMsg = F3(
	function (channelName, maybeOutMsg, _p4) {
		var _p5 = _p4;
		var _p11 = _p5._0;
		var _p10 = _p5._1;
		var _p6 = maybeOutMsg;
		if (_p6.ctor === 'Nothing') {
			...
			if (_p8.ctor === 'Nothing') {
				...
				var push$ = A2(
					...
					payload,
					A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init, 'new:msg', channelName));
				var _p9 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push$, _p8._0);
...
var _user$project$Main$subscriptions = function (model) {
	var _p12 = model.phxSocket;
	if (_p12.ctor === 'Nothing') {
		return _elm_lang$core$Platform_Sub$none;
	} else {
		return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, _p12._0, _user$project$Main$PhoenixMsg);
	}
};
			...
			switch (_p13.ctor) {
				case 'JoinChannel':
					...
					if (_p14.ctor === 'Nothing') {
						...
						var initialChatModel = _user$project$Chat$initialModel;
						var newChat = _elm_lang$core$Native_Utils.update(
							initialChatModel,
							{topic: _p16});
						var newChats = A3(_elm_lang$core$Dict$insert, _p16, newChat, model.chats);
						var channel = _fbonetti$elm_phoenix_socket$Phoenix_Channel$init(_p16);
						var _p15 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$join, channel, _p14._0);
						var phxSocket = _p15._0;
						var phxJoinCmd = _p15._1;
						var phxSocket2 = A4(
							_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
							'new:msg',
							_p16,
							_user$project$Main$ReceiveChatMessage(_p16),
							phxSocket);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
							...
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PhoenixMsg, phxJoinCmd)
						};
					}
				case 'PhoenixMsg':
					var _p17 = model.phxSocket;
					if (_p17.ctor === 'Nothing') {
						...
						var _p18 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, _p13._0, _p17._0);
				...
				case 'ConnectSocket':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								phxSocket: _elm_lang$core$Maybe$Just(
									_user$project$Main$initPhxSocket(model.username))
							}),
						_elm_lang$core$Native_List.fromArray(
							[]));
				case 'HandlePresenceState':
					var _p19 = A2(
						...
						_user$project$Phoenix_Presence$presenceStateDecoder(_user$project$Main$userPresenceDecoder),
						_p13._0);
					if (_p19.ctor === 'Ok') {
						var _p20 = _p19._0;
						var users = A2(
							...
							_elm_lang$core$Dict$keys(_p20));
						var newPresenceState = A2(_user$project$Phoenix_Presence$syncState, _p20, model.phxPresences);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{users: users, phxPresences: newPresenceState}),
							_elm_lang$core$Native_List.fromArray(
								[]));
					} else {
						var _p21 = A2(_elm_lang$core$Debug$log, 'Error', _p19._0);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
							_elm_lang$core$Native_List.fromArray(
				...
				case 'HandlePresenceDiff':
					var _p22 = A2(
						_elm_lang$core$Json_Decode$decodeValue,
						_user$project$Phoenix_Presence$presenceDiffDecoder(_user$project$Main$userPresenceDecoder),
						_p13._0);
					if (_p22.ctor === 'Ok') {
						var newPresenceState = A2(_user$project$Phoenix_Presence$syncDiff, _p22._0, model.phxPresences);
						var users = A2(
							_elm_lang$core$List$map,
							_user$project$Types$User,
						...
						var _p23 = A2(_elm_lang$core$Debug$log, 'Error', _p22._0);
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
							_elm_lang$core$Native_List.fromArray(
				...
				case 'ReceiveChatMessage':
					var _p27 = _p13._0;
					var _p24 = A2(_elm_lang$core$Dict$get, _p27, model.chats);
					if (_p24.ctor === 'Nothing') {
						...
						var _p25 = A2(
							...
							_user$project$Chat$ReceiveMessage(_p13._1),
							_p24._0);
						var newChat = _p25._0;
						var chatCmd = _p25._1;
						var outMsg = _p25._2;
						var newChats = A3(_elm_lang$core$Dict$insert, _p27, newChat, model.chats);
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{chats: newChats});
						var newCmd = A2(
							_elm_lang$core$Platform_Cmd$map,
							_user$project$Main$ChatMsg(_p27),
							chatCmd);
						var _p26 = A3(
							_user$project$Main$handleChatOutMsg,
							_p27,
							outMsg,
				...
				case 'ChatMsg':
					var _p31 = _p13._0;
					var _p28 = A2(_elm_lang$core$Dict$get, _p31, model.chats);
					if (_p28.ctor === 'Nothing') {
						...
						var _p29 = A2(_user$project$Chat$update, _p13._1, _p28._0);
						var newChat = _p29._0;
						var chatCmd = _p29._1;
						var outMsg = _p29._2;
						var newChats = A3(_elm_lang$core$Dict$insert, _p31, newChat, model.chats);
						var newModel = _elm_lang$core$Native_Utils.update(
							model,
							{chats: newChats});
						var newCmd = A2(
							_elm_lang$core$Platform_Cmd$map,
							_user$project$Main$ChatMsg(_p31),
							chatCmd);
						var _p30 = A3(
							_user$project$Main$handleChatOutMsg,
							_p31,
				...
				default:
					var _v13 = _user$project$Main$JoinChannel('room:userchat'),
						_v14 = model;
					msg = _v13;
					model = _v14;
					continue update;
...
var _user$project$Main$lobbyManagementView = A2(
	_elm_lang$html$Html$button,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Events$onClick(
			_user$project$Main$JoinChannel('room:lobby'))
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html$text('Join lobby')
		]));
var _user$project$Main$chatInterfaceView = function (model) {
	var compiled = _user$project$Styles$compile(_user$project$Styles$css);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Main$lobbyManagementView,
				_user$project$Main$rosterView(model),
				_user$project$Main$chatsView(model)
			]));
};
var _user$project$Main$view = function (model) {
	var _p32 = model.phxSocket;
	if (_p32.ctor === 'Nothing') {
		return _user$project$Main$setUsernameView;
	} else {
		return _user$project$Main$chatInterfaceView(model);
	}
};
